namespace CalculoIRRF
{
    partial class FrmDependente
    {
		...
		private void InitializeComponent()
		{
			...
			DgvValorDependente = new System.Windows.Forms.DataGridView();
			...
			((System.ComponentModel.ISupportInitialize)DgvValorDependente).BeginInit();
			SuspendLayout();
			// 
			// BtnExcluir
			// 
			...
			BtnExcluir.Location = new System.Drawing.Point(202, 82);
			...
			BtnAlterar.Location = new System.Drawing.Point(202, 48);
			...
			BtnGravar.Location = new System.Drawing.Point(202, 15);
			...
			// DgvValorDependente
			// 
			DgvValorDependente.AllowUserToAddRows = false;
			DgvValorDependente.AllowUserToDeleteRows = false;
			DgvValorDependente.BackgroundColor = System.Drawing.SystemColors.Control;
			DgvValorDependente.BorderStyle = System.Windows.Forms.BorderStyle.Fixed3D;
			DgvValorDependente.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			DgvValorDependente.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] { Id, Competencia, Valor });
			DgvValorDependente.Location = new System.Drawing.Point(12, 121);
			DgvValorDependente.Margin = new System.Windows.Forms.Padding(4, 3, 4, 3);
			DgvValorDependente.MultiSelect = false;
			DgvValorDependente.Name = "DgvValorDependente";
			DgvValorDependente.ReadOnly = true;
			DgvValorDependente.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
			DgvValorDependente.Size = new System.Drawing.Size(278, 173);
			DgvValorDependente.TabIndex = 10;
			DgvValorDependente.CellDoubleClick += DgvValorSimplificado_CellDoubleClick;
			// 
			// Id
			// 
			...
			// TxtValor
			// 
			TxtValor.Location = new System.Drawing.Point(12, 75);
			...
			// MktCompetencia
			// 
			MktCompetencia.Location = new System.Drawing.Point(12, 30);
			...
			ClientSize = new System.Drawing.Size(302, 305);
			Controls.Add(BtnExcluir);
			Controls.Add(BtnAlterar);
			Controls.Add(BtnGravar);
			Controls.Add(DgvValorDependente);
			...
			((System.ComponentModel.ISupportInitialize)DgvValorDependente).EndInit();
			ResumeLayout(false);
			PerformLayout();
