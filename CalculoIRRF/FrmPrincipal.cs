...
public partial class FrmPrincipal : Form
{
    ...
    {
        FrmTabelaIRRF tabelaIRRF = new(_irrfServices, _dependenteServices, _simplificadoServices);
    ...
    private void LbLinkProjetoGitHub_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
    {
        string url = "https://github.com/mayconwisley/CalculoIRRF";
        try
        {
