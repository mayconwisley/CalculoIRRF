...
public partial class FrmTabelaINSS : Form
{
    ...
    private async void LkLblOnline_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
    {
        try
        {
            ...
            {
                MessageBox.Show("Tabela INSS já está atualizada", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
    ...
    {
        string url = "https://www.contabeis.com.br/tabelas/inss/";
        try
        {
    ...
    private void LblLinkSite2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
    {
        string url = "https://www.debit.com.br/tabelas/tabelas-inss";
        try
        {
            AcessarUrl.Acessar(url);
        }
